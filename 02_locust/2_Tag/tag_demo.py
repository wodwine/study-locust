...
# Post: locust -f 02_locust/2_Tag/tag_demo.py -u 1 -r 1 -t 5s --headless --only-summary --tags post
#       locust -f 02_locust/2_Tag/tag_demo.py -u 1 -r 1 -t 5s --headless --only-summary --exclude-tags get
#  Get: locust -f 02_locust/2_Tag/tag_demo.py -u 1 -r 1 -t 5s --headless --only-summary --tags get
#       locust -f 02_locust/2_Tag/tag_demo.py -u 1 -r 1 -t 5s --headless --only-summary --exclude-tags post
